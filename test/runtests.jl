...
# !!! Main.UserApp is configured as an alias for Main.RubiksGUI and you might encounter it in some tests
using Main.RubiksGUI, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "RubiksGUI tests" begin
  @includetests ARGS
end
